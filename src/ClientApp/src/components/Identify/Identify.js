      ...
      <Container className="identify pt-4">
        ...
        <div className="d-grid identify-addon mb-3 border border-info">
          ...
          <div className="d-grid identify-addon__subgrid">
            <div className="d-flex identify__addon-item pl-1 border-bottom border-info">{calculateAge(extra.date_of_birth)} {props.offender.gender}</div>
        ...
        <h4>{props.offender.offender}
          {extra.race ? extra.race.toLowerCase() === 'unknown' ? null : (
            <small class="text-muted d-block" style={{fontSize: '1rem'}}>{extra.race.toLowerCase()}</small>
          ) : null}
        </h4>
