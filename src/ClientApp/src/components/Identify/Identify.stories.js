...
storiesOf('Identify/Offender Alerts', module)
  .add('normal', () => <OffenderAlerts cautions="cautions" alerts="alerts" />)
  .add('empty cautions', () => <OffenderAlerts cautions="" alerts="alerts" />)
  .add('empty alerts', () => <OffenderAlerts cautions="cautions" alerts={null} />)
  .add('all empty', () => <OffenderAlerts cautions={null} alerts={null} />);

storiesOf('Identify/Recent Visitation', module)
  .add('normal', () => <RecentVisitation office={10} successful={1} attempted={15} />)
  .add('empty office', () => <RecentVisitation office="" successful={1} attempted={15} />)
  .add('empty success', () => <RecentVisitation office={10} successful={null} attempted={15} />)
  .add('empty attempted', () => <RecentVisitation office={10} successful={1} attempted={null} />);
...
storiesOf('Identify/Primary Offense', module)
  .add('normal', () => <PrimaryOffense primary_offense="PERSON" degree="F3" description="i did something very bad" />)
  .add('empty offense/degree', () => <PrimaryOffense primary_offense="" degree="" description="hello" />)
  .add('null and undefined', () => <PrimaryOffense primary_offense="ROBBERY" degree={undefined} description={null} />);

storiesOf('Identify/Gang Information', module)
  .add('normal', () => <GangInformation gang="CRIPS" set="loco yoco" />)
  .add('empty', () => <GangInformation gang={null} set={undefined} />)
  .add('null gang', () => <GangInformation gang={null} set="YOLO" />);

storiesOf('Identify/Other Information', module)
  .add('normal', () => <OtherInformation supervision_start_date={1535760000000} ecc={1535760000000} />)
  .add('empty', () => <OtherInformation supervision_start_date={null} ecc={null} />);
