...
export const basic = () => (<StaticLegend legend={[{
  label: 'test',
  color: '#2ecc40'
}]} />);
...
export const fourColors = () => (<StaticLegend legend={[{
  label: 'test',
  color: '#001f3f'
}, {
  label: 'test2',
...
export const textOverflow = () => (<StaticLegend legend={[{
...
export const invertText = () => (<StaticLegend legend={[{
  label: 'test3',
  color: '#39cccc',
  invert: true
}]} />)
