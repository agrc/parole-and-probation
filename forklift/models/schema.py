...
type_metadata = OrderedDict(
    [
        ...
        ("x", [DECIMAL(24, 20), "float64"]),
        ("y", [DECIMAL(24, 20), "float64"]),
...
AGENT_SQL_TYPES = {
    "id": INTEGER(),
    "value": VARCHAR(128),
    "agent_ein": VARCHAR(64),
    "agent_id": VARCHAR(64),
    "supervisor_id": VARCHAR(64),
    "supervisor_name": VARCHAR(128),
}

output_type_metadata = OrderedDict(
    [
        ("legal_status_code", [CHAR(1), "string"]),
        ("crime_degree", [CHAR(2), "string"]),
        ("gender", [CHAR(1), "string"]),
        ...
        ("county", [VARCHAR(12), "string"]),
        ("score", [DECIMAL(5, 2), "float64"]),
        ("address_start_date", [DATE(), "datetime64[ns]"]),
        ("state", [CHAR(2), "string"]),
        ("zip", [INTEGER(), "Int32"]),
        ("address", [VARCHAR(50), "string"]),
        ("address_type", [VARCHAR(20), "string"]),
...
OUTPUT_SQL_TYPES = {
    header: value[0] for (header, value) in output_type_metadata.items()
}
