...
type_metadata = OrderedDict([
    ...
    ('last_successful_field_contact', [INTEGER(), convert_to_str]),
    ...
    ('last_attempted_field_contact', [INTEGER(), convert_to_str]),
    ('last_office_contact', [INTEGER(), convert_to_str]),
    ('offense_code', [CHAR(1), convert_to_str]),
    ('primary_offense', [VARCHAR(30), convert_to_str]),
    ('region', [SMALLINT(), convert_to_str]),
    ...
    ('unit', [VARCHAR(30), convert_to_str]),
    ...
    ('gang_id', [INTEGER(), convert_to_str]),

    # ('gang_type_id', [INTEGER(), convert_to_str]),
